        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="Sohbet Kanalı", url="t.me/sohbet0lsun".format(bot.username)),  InlineKeyboardButton(text="Oyun Kanalı", url="https://t.me/OYUNADASI")],
                     [InlineKeyboardButton(text="Owner", url="https://t.me/EmirRivia")],
                     [InlineKeyboardButton(text="Yardım", url="https://t.me/{}?start=help".format(bot.username)) ]]))
